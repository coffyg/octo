...
// LogErrorWithRequest logs errors with full request context including host and URL
func LogErrorWithRequest(logger *zerolog.Logger, err error, req *http.Request, ip string) {
	if err == nil || logger == nil || req == nil {
		return
	}

	// Use warning level for 404 errors
